...
__DEFINE__(1608691778913, function(require, module, exports) {
module.exports =
...
const __1 = __webpack_require__(/*! .. */ "./src/api/database/index.ts");
const utils_1 = __webpack_require__(/*! utils/utils */ "./src/utils/utils.ts");
...
const getDatabaseClass = (cloud) => {
    return class Database {
        constructor(config = {}) {
            ...
            let apiEnv = utils_1.isSCFEnvReady() ? utils_1.getEnvFromAPIConfig(config, cloud.config, __1.DATABASE_SERVICE_NAME) :
                (cloud.config.env && (cloud.config.env.database || cloud.config.env.default));
            // @ts-ignore
            const tcbConfig = Object.assign(Object.assign({}, tcb.config), { 
                // @ts-ignore
                env: apiEnv, 
                // @ts-ignore
            ...
            const tcbInstance = tcb.init(tcbConfig);
...
/******/ });
}, function(modId) {var map = {"./package.json":1608691778914}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1608691778914, function(require, module, exports) {
module.exports = {
  "_from": "wx-server-sdk@latest",
  "_id": "wx-server-sdk@1.7.0",
  "_inBundle": false,
  "_integrity": "sha512-WVXo1Rl30LZE5KPsdfdAMG4r38MA3qkJ/KzdaRr3oaRqgrnZgtbCs0gcLOKR3oGrIRSBmmjdTAVNk9ThfOfxBA==",
  ...
  "_resolved": "https://registry.npmjs.org/wx-server-sdk/-/wx-server-sdk-1.7.0.tgz",
  "_shasum": "304a678671e748d979f705552fb17bb5e5627942",
...
return __REQUIRE__(1608691778913);
})()
